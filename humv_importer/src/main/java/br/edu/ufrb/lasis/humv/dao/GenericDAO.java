...
/**
 * The Class GenericDao is the superclass for the custom data access object
 * classes. This class is never used directly by controller classes, instead,
 * subclasses extend GenericDao to provide specific behavior according to the
 * entity. In this class, the entities are objects from classes mapped in the
 * database.
 *
...
public abstract class GenericDAO<T extends Serializable> {
    ...
    /**
     * Gets the number of objects registered in the database. If necessary, a
     * constraint is added to the Hibernate query in order to filter the
     * results.
     *
     * @param className class name of the desired objects
     * @param constraintString the constraint string to filter results (null is
     * used when the constraint is not necessary)
    ...
    /**
     * Find entities in the database according to a specific value in the
     * specified column.
     *
