...
public class LiberacaoMaterialJPanel extends javax.swing.JPanel {
    private SolicitacaoMaterial solicitacaoMaterial;
    private final static Logger logger = LoggerFactory.getLogger(LiberacaoMaterialJPanel.class);

    public LiberacaoMaterialJPanel(SolicitacaoMaterial solicitacaoMaterial) {
        initComponents();
