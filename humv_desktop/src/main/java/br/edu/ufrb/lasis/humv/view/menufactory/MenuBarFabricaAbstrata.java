...
import br.edu.ufrb.lasis.humv.view.material.CadastrarMaterialJPanel;
...
public abstract class MenuBarFabricaAbstrata implements ActionListener {
    ...
    private JButton buttonCadastrarMaterial;
    ...
    public void criaBotaoCadastrarMaterial() {
        buttonCadastrarMaterial = new JButton("Cadastrar material", new ImageIcon("imagens/icon_questionario.png"));
        buttonCadastrarMaterial.addActionListener(this);
        this.addButtonToRightPanel(buttonCadastrarMaterial);
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (source.equals(menuItemSobre)) {
            ...
            HUMVApp.setNovoPainelCentral(buscaPanel);
        } else if (source.equals(menuItemCadastroMaterial) || source.equals(buttonCadastrarMaterial)) {
            CadastrarMaterialJPanel tela = new CadastrarMaterialJPanel();
